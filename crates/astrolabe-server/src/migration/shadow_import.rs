            ...
            let rule = astrolabe_panel::semantic::semantic_rule_by_slot(slot.slot_id())
                .ok_or_else(|| {
                    astrolabe_panel::PanelError::invalid_vector(
                        ...
                        "Restore the exact current semantic registry before indexing.",
                    )
                })?;
...
///
/// The current roster minus S22 (`token_multi`, `SlotShape::Multi` — the CBM shadow
    ...
    C: Clock,
{
    ...
    Ok(json!({
        ...
        "complete_associations": {
            ...
            "pair_outcomes_written": complete_xterms.pair_outcomes_written,
            "pair_outcomes_unchanged": complete_xterms.pair_outcomes_unchanged,
            "pair_outcomes_tombstoned": complete_xterms.pair_outcomes_tombstoned,
            "blocks_written": complete_xterms.blocks_written,
            "blocks_unchanged": complete_xterms.blocks_unchanged,
            "blocks_tombstoned": complete_xterms.blocks_tombstoned,
            "legacy_rows_tombstoned": complete_xterms.legacy_rows_tombstoned,
