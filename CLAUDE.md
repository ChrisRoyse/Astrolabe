...
- **Autonomous project decisions:** make and execute the technical, prioritization, and implementation choices required to reach ASTROLABE's intended end state. Choose the most robust, durable, project-aligned option rather than a locally easier workaround; do not pause for routine approval or leave a known next step undecided.
