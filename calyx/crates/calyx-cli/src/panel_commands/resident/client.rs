...
fn resident_remote_error_code(remote_code: &str) -> Option<&'static str> {
    Some(match remote_code {
        ...
        "CALYX_PANEL_RESIDENT_GPU_NEURAL_REQUIRED" => "CALYX_PANEL_RESIDENT_GPU_NEURAL_REQUIRED",
        ...
        "CALYX_PANEL_RESIDENT_LOAD_CANCELLED" => "CALYX_PANEL_RESIDENT_LOAD_CANCELLED",
        ...
        "CALYX_PANEL_RESIDENT_NO_APPLICABLE_GPU_LENS" => {
            "CALYX_PANEL_RESIDENT_NO_APPLICABLE_GPU_LENS"
        }
        "CALYX_PANEL_RESIDENT_PROTOCOL_MISMATCH" => "CALYX_PANEL_RESIDENT_PROTOCOL_MISMATCH",
        "CALYX_PANEL_RESIDENT_QUEUED_CLIENT_GONE" => "CALYX_PANEL_RESIDENT_QUEUED_CLIENT_GONE",
        "CALYX_PANEL_RESIDENT_REQUEST_DEADLINE" => "CALYX_PANEL_RESIDENT_REQUEST_DEADLINE",
        ...
        "CALYX_PANEL_RESIDENT_WORKER_BACK_PRESSURE" => "CALYX_PANEL_RESIDENT_WORKER_BACK_PRESSURE",
