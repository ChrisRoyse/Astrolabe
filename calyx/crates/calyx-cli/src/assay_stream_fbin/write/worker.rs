...
impl StreamWorkerReport {
    pub(crate) fn into_lens_evidence(self, args: &Args) -> CliResult<LensEvidence> {
        ...
        Ok(LensEvidence {
            ...
            corpus_source_blake3: self.corpus_source_blake3,
            queries_payload_blake3: self.queries_payload_blake3,
            queries_source_blake3: self.queries_source_blake3,
...
fn stream_selected(
    ...
    let report = StreamWorkerReport {
        ...
        corpus_source_blake3: digests.corpus_source_blake3,
        queries_payload_blake3: digests.queries_payload_blake3,
        queries_source_blake3: digests.queries_source_blake3,
