...
pub use error::{
    ...
    CALYX_SEXTANT_GRAPH_HOP_KIND_UNKNOWN, CALYX_SEXTANT_HNSW_ARTIFACT_CORRUPT,
    CALYX_SEXTANT_HNSW_ARTIFACT_IO, CALYX_SEXTANT_HNSW_ARTIFACT_STALE,
    CALYX_SEXTANT_HNSW_ARTIFACT_UNSUPPORTED, CALYX_SEXTANT_HNSW_POINTER_CORRUPT,
    CALYX_SEXTANT_HNSW_POINTER_IO, CALYX_SEXTANT_HNSW_POINTER_STALE,
    CALYX_SEXTANT_HNSW_POINTER_UNSTAGED, CALYX_SEXTANT_INDEX_EMPTY, CALYX_SEXTANT_NO_LENSES,
...
pub use index::{
    ...
    FunnelPath, HNSW_ACTIVE_POINTER_MAGIC, HNSW_ACTIVE_POINTER_VERSION, HNSW_ARTIFACT_MAGIC,
    HNSW_ARTIFACT_VERSION, HNSW_MAX_DIM, HnswActivePointer, HnswArtifactActivator,
    HnswArtifactExpectation, HnswArtifactMetadata, HnswArtifactReceipt, HnswIndex, IndexSearchHit,
    IndexStats, InvertedIndex, KernelFirstSearch, KernelRegion, KernelRegionAnn, KernelRegionId,
    LocalCxId, MaxSimIndex, PackedQuery, PackedVector, PostingListReader, PostingListWriter,
    PostingMember, QuantConfig, QuantKind, RegionCandidate, RegionId, RegionPartitions,
    SEXTANT_QUANT_LAYOUT_VERSION, SPANN_ACTIVE_MAGIC, SPANN_CENTROID_MAGIC, SPANN_MANIFEST_MAGIC,
    SPANN_POSTING_FORMAT_VERSION, SPANN_POSTING_SEGMENT_MAGIC, SPANN_STATE_SEGMENT_MAGIC,
    SextantIndex, SpannCentroidIndex, SpannDistanceMetric, SpannIndexIdentity, SpannPostingLimits,
    SpannPostingPhysicalStats, SpannPostingWriteReceipt, SpannSearch, SyntheticVault,
    ...
    build_dual_with_search, build_synthetic_vault, decode_posting_block, dual_graph_path,
    encode_posting_block, open_dual, register_with_anneal, score_packed, synthetic_dense_rows,
};
pub use navigation::{
