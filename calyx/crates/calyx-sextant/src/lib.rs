...
pub use index::{
    ...
    SEXTANT_QUANT_LAYOUT_VERSION, SPANN_CENTROID_MAGIC, SextantIndex, SpannCentroidIndex,
    SpannSearch, SyntheticVault, TuneDirection, TunerAdjustment, TunerAdjustmentKind, TunerConfig,
    ...
    register_with_anneal, score_packed, synthetic_dense_rows,
};
pub use navigation::{
