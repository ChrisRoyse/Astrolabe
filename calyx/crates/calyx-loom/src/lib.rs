...
pub use error::{
    CALYX_LOOM_DIM_MISMATCH, CALYX_LOOM_EXPECTED_GAIN_INVALID,
    CALYX_LOOM_EXPECTED_GAIN_NUMERIC_INVALID, CALYX_LOOM_FORGE_UNAVAILABLE,
    CALYX_LOOM_NON_FINITE_VECTOR, CALYX_LOOM_SERIES_READ_ERROR, CALYX_LOOM_SLOT_MISSING,
...
pub use expected_gain::{
    EXPECTED_GAIN_SCHEMA, ExpectedGain, ExpectedGainInput, calculate_expected_gains,
};
