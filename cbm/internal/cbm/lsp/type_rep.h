...
// Follow an alias chain through a caller-selected strict depth limit. Exhaustion
// is a sticky analysis failure so a shortened semantic graph cannot publish.
